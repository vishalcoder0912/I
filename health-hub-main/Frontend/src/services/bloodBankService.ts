...
export const bloodBankService = {
  ...
  async addBloodUnit(unitData: Omit<BloodBank, 'id' | 'created_at' | 'updated_at'>) {
    try {
      ...
      if (error) return handleSupabaseError(error);
      return { error: false, data, message: 'Blood unit added successfully' };
    } catch (error) {
      return handleSupabaseError(error);
    }
  },
  ...
  async updateBloodUnit(unitId: string, updates: Partial<BloodBank>) {
    try {
      ...
      if (error) return handleSupabaseError(error);
      return { error: false, data, message: 'Blood unit updated successfully' };
    } catch (error) {
      return handleSupabaseError(error);
    }
  },
  ...
  async reserveBloodUnit(unitId: string) {
    try {
      ...
      if (error) return handleSupabaseError(error);
      return { error: false, data, message: 'Blood unit reserved successfully' };
    } catch (error) {
      return handleSupabaseError(error);
    }
  },
  ...
  async deleteBloodUnit(unitId: string) {
    try {
      ...
      if (error) return handleSupabaseError(error);
      return { error: false, message: 'Blood unit deleted successfully' };
    } catch (error) {
      return handleSupabaseError(error);
    }
  },
